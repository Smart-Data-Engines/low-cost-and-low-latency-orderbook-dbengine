...
Verified by [the full CI run for PR #141](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/35012089020),
on the tree containing #126 to **#135 with #121 answered** — which was the page's **last open
item**: every loop in `src/` guards one iteration at a time, a node whose registry entry is
