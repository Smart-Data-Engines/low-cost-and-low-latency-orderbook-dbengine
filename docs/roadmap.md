...
Verified by [the full CI run for PR #132](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/34916006367),
on the tree containing #126 to #133 — which is **every loop in `src/`** guarding one iteration at a
time, plus the three items that closing #112 produced. Runtimes below are from GitHub's
