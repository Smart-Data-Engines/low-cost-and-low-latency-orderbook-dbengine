...
Verified by [the full CI run for PR #157](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/35460896495),
on the tree carrying the snapshot install that replaces the store (#142).
