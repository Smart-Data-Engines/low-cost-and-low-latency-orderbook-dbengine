...
Verified by [the full CI run for PR #180](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/35938183009),
on the tree whose `SNAPSHOT` answers its columns over the wire and the latest row at or before its
time (#167, #168).
