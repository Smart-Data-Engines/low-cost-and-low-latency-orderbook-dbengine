...
**#165 is open, and a P0** — the mechanical list is the `Open:` line below; read it there rather
than trusting this paragraph, which is prose and has been wrong about this before. **#166 was a P0
...
**#165** is a slope: nothing merges segments, so a node gains one per
...
**Open: #165.** Every other item above #58 is marked closed, and
...
Verified by [the full CI run for PR #177](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/35911262720),
