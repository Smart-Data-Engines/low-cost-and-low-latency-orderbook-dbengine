...
Verified by [the full CI run for PR #168](https://github.com/Smart-Data-Engines/low-cost-and-low-latency-orderbook-dbengine/actions/runs/35793374848),
on the tree carrying the client event loops dealt connections in turn (#151).
